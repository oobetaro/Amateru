...
public class CuspTable {
     ...
     */
    public CuspTable(PlanetRing [] planetRings,ZodiacPanel zodiacPanel ) {
    ...
    private void createCuspListLayout() {
        cuspsLayout = new GBoxLayout(GBoxLayout.VERTICAL);
        cuspLabelList = new ArrayList<GCuspLabel>();
        houseCuspLabel.setInset(G_BOTTOM,1);
        cuspsLayout.add( houseCuspLabel );
        ...
        for(int i=0; i<12; i++) {
            ...
            cuspsLayout.add( cuspLabel );
        }
        cuspsLayout.setLocation(2,65,G_LEFT,G_BOTTOM);
        zodiacPanel.addGLayout(cuspsLayout);
    }
    ...
    public void setLocation(double xper,double yper,
        ...
        cuspsLayout.setLocation(xper,yper,alignx,aligny);
    }
