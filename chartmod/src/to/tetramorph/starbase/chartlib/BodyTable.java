 ...
 * @author 大澤義鷹
 */
public class BodyTable extends GBoxLayout {
    ...
    * @param planetRings 天体座標をテーブル表示したい惑星リングをセット
    */
    ...
    public void updateBodyList( int [] bodyIDs, String tableName ) {
        //System.out.println("★おいおいおい updateBodyList");
        //使用している天体をSetに格納
        ...
        setLocation( 15, 65, G_LEFT, G_BOTTOM );
    }
