...
/**
 * ShutterPaneなどで使用される最小化ボタン。
 * @author 大澤義鷹
 */
public class PanelMinimizeButton extends JRadioButton {
  ...
  static {
    normalIcon = IconLoader.getImageIcon("/resources/min0.gif");
    enteredIcon =  IconLoader.getImageIcon("/resources/min1.gif");
    pressedIcon = IconLoader.getImageIcon("/resources/min2.gif");
  }
