...
/**
 * 検索モジュール"searchmod.jar"の一覧を標準出力にダンプする。<br>
 ...
 * アマテルはそれを参照して、searchmod.jarからクラスファイルを動的に読みこむ。<br>
...
public class Main {
     ...
     * @param args 引数は指定しても無視する。
     * @throws Exception ファイル関連でエラーがあった時。
     */
    public static void main( String [] args ) throws Exception {
        System.out.println("\"searchmod.jar\"内のMANIFEST.MFに記述されている" +
                           "アマテル検索モジュール一覧");
